...
export default function Cart() {
  const { cartItems, showCart, setShowCart, qty, onAdd, onRemove, totalPrice } =
    useStateContext();
  //Payment (Post request for passing data to stripe)
  ...
  const handleCheckout = async () => {
    ...
    console.log(data);
    await stripe.redirectToCheckout({ sessionId: data.id }); //inbuilt funtion for stripe
  };
